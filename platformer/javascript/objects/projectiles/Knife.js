function Knife(level, originEntity, targets, position, direction){
    ...
    this.animations.moving = new Animation('moving', platformer.textures.items.knifeMoving, 1000);
    this.animations.idle = new Animation('idle', platformer.textures.items.knifeIdle, 0);
