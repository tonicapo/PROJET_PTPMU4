function BackEnd(){
    ...
    playerlogged = new CustomEvent("playerlogged");
    ...
    function createForm(id){
        ...
        texte.innerHTML = 'Merci de renseigner vos identifiants :';
        ...
        texte_change.innerHTML = 'Pas encore inscrit ? Inscrivez vous';

        texte_change.addEventListener(change_form);
    }
}
